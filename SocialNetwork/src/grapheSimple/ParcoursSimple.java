...
public class ParcoursSimple {
	...
	public ArrayList<Chemin> chemins(Sommet origine){
		...
		ArrayList<Chemin> chemins = chemins(origine,dejaVu);
		return chemins;
	}
	 ...
	 * Cette méthode renvoie tous les chemins entre deux Sommets donnes
	 */
	//Pbme avec la comparaison des chemins... qui considere comme égal deux objets différents... cela doit venir de l'héritage...
