...
/**
 * Super-classe abstraite des graphes, les sommets doivent être identifiables.
 * 
...
public abstract class GrapheGenerique<S extends Identifiable> {
  ...
  /**
   * @param s
   *          le sommet à ajouter à ce graphe.
   */
  ...
  /**
   * Teste l'existence de l'arc de <tt>s</tt> à <tt>t</tt> dans ce graphe.
   * 
   * @param s
   *          l'origine de l'arc,
   * @param t
   ...
   *          l'extrémité de l'arc,
   * @param val
   *          une valeur entière attachée à l'arc de <tt>s</tt> à <tt>t</tt>
   *          dans ce graphe.
   */
   ...
   * @param t
   *          l'extrémité de l'arc.
   * @return la valeur entière attachée à l'arc de <tt>s</tt> à <tt>t</tt>
   *         dans ce graphe.
   */
  public abstract int valeurArc(S s, S t);

  /**
   * Supprime l'arc de <tt>s</tt> à <tt>t</tt> dans ce graphe.
   * 
   * @param s
   *          l'origine de l'arc,
   * @param t
